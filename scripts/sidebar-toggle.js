...
document.addEventListener("DOMContentLoaded", function () {
  ...
  tabs.forEach(function (tab) {
    tab.addEventListener("click", function () {
      ...
      document
        .getElementById("sheet-panel-" + tab.dataset.tab)
  ...
  if (navGuide)
    navGuide.addEventListener("click", function () {
  ...
  if (fab && picker) {
    ...
    picker.querySelectorAll("button").forEach(function (btn) {
      btn.addEventListener("click", function (e) {
        ...
        btn.classList.add("active");
        picker.style.display = "none";
        if (globalThis._elancoMap && globalThis.layers) {
          Object.values(globalThis.layers).forEach((l) => {
            if (globalThis._elancoMap.hasLayer(l))
              globalThis._elancoMap.removeLayer(l);
          });
          if (globalThis.layers[key])
            globalThis.layers[key].addTo(globalThis._elancoMap);
        }
      });
    });
  }
